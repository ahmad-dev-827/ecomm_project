                    ...
                    <div class="text-contant">
                        <h2>
                            <span class="center"><span class="icon"><img
                                        src="https://github.com/tauseedzaman/hospitalMS/blob/main/public/images/icon-logo.png?raw=true"
                                        alt="#"></span></span>
        ...
        <div class="container">
            ...
            <div class="heading">
                <span class="icon-logo">
                    <img src="https://github.com/tauseedzaman/hospitalMS/blob/main/public/images/icon-logo.png?raw=true"
                        alt="#"></span>
                <h2>The Specialist Clinic</h2>
            </div>
