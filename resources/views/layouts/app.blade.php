...
<head>
    ...
    <link rel="shortcut icon"
        href="https://github.com/tauseedzaman/hospitalMS/blob/main/public/images/fevicon.ico.png?raw=true" />
        ...
        <div class="header-top wow fadeIn">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}"><img
                        src="https://github.com/tauseedzaman/hospitalMS/blob/main/public/images/logo.png?raw=true"
                        alt="logo image "></a>
                    ...
                    <div class="header-info">
                        ...
                        <div class="info-inner">
                            ...
                            <span class="iconcont"><a data-scroll
                                    href="mailto:{{ $settings['email'] ?? 'ahmadhoo@gmail.com' }}">{{ $settings['email'] ?? 'ahmadhoo@gmail.com' }}</a></span>
                        </div>
                        <div class="info-inner">
                ...
                <div class="col-md-4">
                    <div class="footer-info padding">
                        ...
                        <p><i class="fa fa-map-marker" aria-hidden="true"></i>
                            {{-- {{ $settings['address'] ?? --}}
                            {{ 'Allama Iqbal Colony Fsd, Pak' }}
                        </p>
                        <p><i class="fa fa-paper-plane"
                                aria-hidden="true"></i>{{ $settings['email'] ?? 'ahmad@gmail.com' }}
                        </p>
